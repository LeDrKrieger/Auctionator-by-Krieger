...
AtrL["SCAN_EXPLANATION"] = "Scanning the auction house builds a database of prices that Auctionator uses for two purposes: to display in item tooltips "
							...
							.."<br/><br/>"
							.."Scanning usually takes about 10 seconds when instant scanning is supported.  "
							.."On servers that do not support instant scanning, Auctionator scans page by page and shows progress while it works.  "
							.."Note that Blizzard only allows instant scanning once every 15 minutes."
							.."<br/><br/>"
